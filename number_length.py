...
from number2words import get_number_name, _fix_pronunciation, _get_place_rule, _PLACE_SPECIALS, _PLACE_UNITS, _PLACE_TENS, _PLACE_HUNDREDS, _PLACE_BIGS, _PLACE_ILLION
getcontext().prec = 10_001
